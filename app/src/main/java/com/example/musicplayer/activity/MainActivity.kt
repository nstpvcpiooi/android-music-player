...
//       findViewById<LinearLayout>(R.id.linearLayoutNav)?.setBackgroundResource(currentGradient[1])
//
...
//                }
//                Toast.makeText(this@MainActivity, "Search: $newText", Toast.LENGTH_SHORT).show()
//                return true
//            }
//        })
//
