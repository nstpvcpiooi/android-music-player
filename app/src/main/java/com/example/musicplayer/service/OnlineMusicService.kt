...
class OnlineMusicService : Service(), AudioManager.OnAudioFocusChangeListener {
    ...
    inner class MyBinder : Binder() {
        fun currentService(): OnlineMusicService {
    ...
    fun createMediaPlayer() {
        try {
            ...
            PlayerActivity.nowPlayingId = musicList[songPosition].id
    ...
    private fun prevNextSong(increment: Boolean, context: Context){
        ...
        PlayerActivity.binding.songNamePA.text = musicList[songPosition].title
        ...
        NowPlaying.binding.songNameNP.text = musicList[songPosition].title

        playMusic()

        PlayerActivity.fIndex = favouriteChecker(musicList[songPosition].id)
